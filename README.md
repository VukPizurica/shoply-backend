...
I didn't manage to deoploy backend so it needs to be downloaded from GitHub repository and started on localhost 8080. SQL server needs to be running with a connection: username root and password root. 
